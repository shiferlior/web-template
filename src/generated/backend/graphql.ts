...
export const GetEntitiesDocument = gql`
  ...
  entities {
    ...
    `;
export const InsertPayMethodDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    insertPayMethod(variables?: InsertPayMethodMutationVariables): Promise<InsertPayMethodMutation> {
      return withWrapper(() => client.request<InsertPayMethodMutation>(print(InsertPayMethodDocument), variables));
    }
  };
}
