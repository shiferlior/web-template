...
export const GetProjectManagersDocument = `
  ...
  project_managers {
    ...
    `;
export const useGetProjectManagersQuery = (variables?: GetProjectManagersQueryVariables, options?: QueryConfig<GetProjectManagersQuery>) => 
  useQuery<GetProjectManagersQuery>(
    ['getProjectManagers', variables],
    fetcher<GetProjectManagersQuery, GetProjectManagersQueryVariables>(GetProjectManagersDocument, variables),
    options
  );
export const GetEntitiesDocument = `
  ...
  entities {
    ...
    `;
export const useGetEntitiesQuery = (variables?: GetEntitiesQueryVariables, options?: QueryConfig<GetEntitiesQuery>) => 
  useQuery<GetEntitiesQuery>(
    ['getEntities', variables],
    fetcher<GetEntitiesQuery, GetEntitiesQueryVariables>(GetEntitiesDocument, variables),
    options
  );